...
public void getArrayList(String _json, ArrayList<HashMap<String, String>> array, String object1, String  object2, String object3, String object4,
		String object5, String object6,String object7, String object8) throws JSONException{
	...
	for (int i = 0; i < jArray.length(); i++) {
		...
		String _object3 = json.getString(object3);
		String _object4 = json.getString(object4);
		String _object5 = json.getString(object5);
		String _object6 = json.getString(object6);
		String _object7 = json.getString(object7);
		String _object8 = json.getString(object8);

		map.put(object1, _object1);
		map.put(object2, _object2);
		map.put(object3, _object3);
		map.put(object4, _object4);
		map.put(object5, _object5);
		map.put(object6, _object6);
		map.put(object7, _object7);
		map.put(object8, _object8);
